 ...
 * 将颜色对象转换为rgba颜色字符串
 *
 * @param {IRgba} colorObj - 颜色对象，包含r、g、b分量，可选a分量
 * @param {number} [n=10000] - 透明度的小数点后保留位数，默认为10000（即保留4位小数）
 ...
 * @returns {IRgba | string} 包含RGBA分量的对象，如果无法解析则返回空字符串
 * @example
 * ```javascript
