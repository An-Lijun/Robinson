import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.a333c6fb.js";const b=JSON.parse('{"title":"使用缓存","description":"","frontmatter":{},"headers":[],"relativePath":"etc/docs/src/use.md","filePath":"etc/docs/src/use.md"}'),p={name:"etc/docs/src/use.md"},e=l(`<h1 id="使用缓存" tabindex="-1">使用缓存 <a class="header-anchor" href="#使用缓存" aria-label="Permalink to &quot;使用缓存&quot;">​</a></h1><p>缓存可以显著提高构建速度，特别是在开发环境中。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">import { rollup } from &#39;rollup&#39;;</span></span>
