...
{ "\_\_\#9089@\#storage": any; "\_\_\#9089@\#encode": Function; "\_\_\#9089@\#decode": Function; setCache(key: string, value: any, expire: number): void; getCache(encodeKey: string): any; removeCache(key: string): void; has(key: string): boolean; length(): any; clear(): void; }
